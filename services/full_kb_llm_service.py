    ...
    async def run_turn(
        ...
        try:
            ...
            system_prompt = (
                ...
                "0.4) For complaints or explicit requests for human help, stay phase-aware: treat as actionable staff work only when mapped to a current-phase allowed service.\n"
                "0.5) If the issue maps only to an out-of-phase service, acknowledge the concern but do not promise immediate staff dispatch or resolution in this phase.\n"
                ...
                "    - For complaint or human-help asks that need staff intervention in an allowed current-phase service, prefer requires_ticket=true even without booking keywords.\n"
                "    - If the mapped service is out of phase, do not create an immediate operational ticket for that blocked service; keep ticket_ready_to_create=false unless rerouted to a current-phase ticketable service.\n"
                ...
                "    - For actionable in-phase complaints, communicate ownership clearly and confirm staff follow-up without inventing exact ETA.\n"
                "    - For out-of-phase complaints, acknowledge, explain phase limits, and offer phase-appropriate human support without immediate dispatch promises.\n\n"
